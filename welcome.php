    ...
    <?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 mb-20 p-0-xs p-0-sm p-10-md text-center">
                ...
                <div class="text-left mt-10">Затем высылаете им приглашение, личное сообщение и т.д., но делаете это на порядок быстрее, если бы делали это самостоятельно.</div>
            </div>
